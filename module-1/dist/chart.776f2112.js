...
async function drawLineChart() {
  ...
  const freezingTemps = bounds.append("rect").attr("x", 0).attr("width", dimensions.boundedWidth).attr("y", freezingTempPlacement).attr("height", dimensions.boundedHeight - freezingTempPlacement).attr("fill", "#e0f3f3");
  ...
  const line = bounds.append("path").attr("d", lineGenerator(data)).attr("fill", "none").attr("stroke", "#af9358").attr("stroke-width", 2);
